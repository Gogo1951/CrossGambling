...
function CrossGambling:DrawMainEvents()
    ...
    function LoadColor()
        frameColor.r, frameColor.g, frameColor.b =
            self.db.global.colors.frameColor.r,
            self.db.global.colors.frameColor.g,
            self.db.global.colors.frameColor.b
        CrossGamblingUI:SetBackdropColor(frameColor.r, frameColor.g, frameColor.b)

        buttonColor.r, buttonColor.g, buttonColor.b =
            self.db.global.colors.buttonColor.r,
            self.db.global.colors.buttonColor.g,
            self.db.global.colors.buttonColor.b
        sideColor.r, sideColor.g, sideColor.b =
            self.db.global.colors.sideColor.r,
            self.db.global.colors.sideColor.g,
            self.db.global.colors.sideColor.b
    ...
    function SaveColor()
        self.db.global.colors.frameColor.r, self.db.global.colors.frameColor.g, self.db.global.colors.frameColor.b =
            frameColor.r,
            frameColor.g,
            frameColor.b
        self.db.global.colors.buttonColor.r, self.db.global.colors.buttonColor.g, self.db.global.colors.buttonColor.b =
            buttonColor.r,
            buttonColor.g,
            buttonColor.b
        self.db.global.colors.sideColor.r, self.db.global.colors.sideColor.g, self.db.global.colors.sideColor.b =
            sideColor.r,
            sideColor.g,
            sideColor.b
    ...
    CGHistoryLog:SetScript(
        "OnEnter",
        function()
            highlightHistory:Show()
        end
    )
    CGHistoryLog:SetScript(
        "OnLeave",
        function()
            highlightHistory:Hide()
        end
    )
    CGHistoryLog:SetScript(
        "OnMouseDown",
    ...
    function CrossGambling:PurgeOldAuditEntries()
        ...
        if retention == -1 or retention == "Never" then
            return
        end
            ...
            if type(entry) == "table" then
                ...
                if entry.action == "updateStat" then
                    textLine =
                        ...
                        ts,
                        entry.player or "?",
                        entry.oldAmount or 0,
                        entry.addedAmount or 0,
                        entry.newAmount or 0
                    )
                elseif entry.action == "joinStats" then
                    textLine =
                        ...
                        entry.altname or "?",
                        entry.mainname or "?",
                        entry.statsAdded or 0,
                        entry.deathrollStatsAdded or 0
                    )
                elseif entry.action == "unjoinStats" then
                    textLine =
                        ...
                        entry.altname or "?",
                        entry.mainname or "?",
                        entry.pointsRemoved or 0,
                        entry.deathrollStatsRemoved or 0
                    )
    ...
    CGRightMenu.TextField:SetScript(
        "OnMouseWheel",
        function(self, delta)
            if (delta == 1) then
                self:ScrollUp()
    ...
    local scrollFrame =
        CreateFrame("ScrollFrame", "PlayerListScrollFrame", playerListFrame, "UIPanelScrollFrameTemplate")
